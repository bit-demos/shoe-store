...
An array of mock data to show some products according to the data structure. This data strucuture extends the e-commerce entity and adds the extra types of available colors and shoe size to the data structure.
...
- A shoes foler which contains all domain components specific to shoes. By creating a custom prouct card component we have the flexibility of making this coponent diferent to the basic e-commerce component and add extra functionality etc. This gives us complete owership ove the component. However the components here are still made up from the smaller components of the base-ui scope as well as some of the compnents from the e-commerce scope.
